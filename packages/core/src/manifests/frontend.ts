...
export function registerFrontendManifest(): void {
	registerManifest({
		...
		files: [
			...
			{ path: 'src/frontend/src/app.d.ts', templated: true },
			...
			{ path: 'src/frontend/src/lib/api/v1.d.ts', templated: true },
			{ path: 'src/frontend/src/lib/auth/auth.test.ts', templated: true },
			{ path: 'src/frontend/src/lib/auth/auth.ts', templated: true },
			{ path: 'src/frontend/src/lib/auth/index.ts', templated: true },
			{ path: 'src/frontend/src/lib/auth/middleware.test.ts', templated: true },
			{ path: 'src/frontend/src/lib/auth/middleware.ts', templated: true },
			...
			{ path: 'src/frontend/src/lib/components/auth/AuthShell.svelte', templated: true },
			{
			...
			{ path: 'src/frontend/src/lib/components/auth/ResetPasswordForm.svelte', templated: true },
			...
			{ path: 'src/frontend/src/lib/components/layout/Header.svelte', templated: true },
			...
			{ path: 'src/frontend/src/lib/components/layout/UserNav.svelte', templated: true },
			{ path: 'src/frontend/src/lib/components/layout/index.ts', templated: true },
			{
			...
			{ path: 'src/frontend/src/lib/components/profile/AccountDetails.svelte', templated: true },
			...
			{ path: 'src/frontend/src/lib/components/profile/InfoItem.svelte', templated: true },
			{ path: 'src/frontend/src/lib/components/profile/ProfileForm.svelte', templated: true },
			...
			{ path: 'src/frontend/src/lib/schemas/auth.ts', templated: true },
			...
			{ path: 'src/frontend/src/lib/state/shortcuts.svelte.ts', templated: true },
			...
			{ path: 'src/frontend/src/messages/en/core.json', templated: false },
			{ path: 'src/frontend/src/messages/cs/core.json', templated: false },
			{ path: 'src/frontend/src/messages/en/dashboard.json', templated: false },
			{ path: 'src/frontend/src/messages/cs/dashboard.json', templated: false },
			...
			{ path: 'src/frontend/src/routes/(app)/layout.server.test.ts', templated: true },
			{ path: 'src/frontend/src/routes/(app)/profile/+page.svelte', templated: true },
			{ path: 'src/frontend/src/routes/(app)/settings/+page.svelte', templated: true },
			{ path: 'src/frontend/src/routes/(public)/+layout.server.ts', templated: true },
			{
				path: 'src/frontend/src/routes/(public)/forgot-password/+page.server.ts',
				templated: true
			},
			{ path: 'src/frontend/src/routes/(public)/forgot-password/+page.svelte', templated: true },
			{ path: 'src/frontend/src/routes/(public)/login/+page.server.ts', templated: true },
			{ path: 'src/frontend/src/routes/(public)/login/+page.svelte', templated: true },
			{ path: 'src/frontend/src/routes/(public)/login/page.server.test.ts', templated: true },
			...
			{ path: 'src/frontend/src/routes/(public)/register/+page.server.ts', templated: true },
			{ path: 'src/frontend/src/routes/(public)/register/+page.svelte', templated: true },
			{ path: 'src/frontend/src/routes/(public)/reset-password/+page.server.ts', templated: true },
			{ path: 'src/frontend/src/routes/(public)/reset-password/+page.svelte', templated: true },
			{ path: 'src/frontend/src/routes/(public)/verify-email/+page.server.ts', templated: true },
			{ path: 'src/frontend/src/routes/(public)/verify-email/+page.svelte', templated: true },
			{ path: 'src/frontend/src/routes/+error.svelte', templated: false },
			{ path: 'src/frontend/src/routes/+layout.server.ts', templated: true },
			{ path: 'src/frontend/src/routes/+layout.svelte', templated: true },
			...
			{ path: 'src/frontend/src/routes/layout.server.test.ts', templated: true },
			...
			{ path: 'src/frontend/static/android-chrome-192x192.png', templated: false, binary: true },
			{ path: 'src/frontend/static/android-chrome-512x512.png', templated: false, binary: true },
			{ path: 'src/frontend/static/apple-touch-icon.png', templated: false, binary: true },
			{ path: 'src/frontend/static/favicon-16x16.png', templated: false, binary: true },
			{ path: 'src/frontend/static/favicon-32x32.png', templated: false, binary: true },
			{ path: 'src/frontend/static/favicon.ico', templated: false, binary: true },
			{ path: 'src/frontend/src/routes/robots.txt/+server.ts', templated: true },
			{ path: 'src/frontend/src/routes/sitemap.xml/+server.ts', templated: false },
