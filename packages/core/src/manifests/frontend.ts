...
export function registerFrontendManifest(): void {
	registerManifest({
		...
		files: [
			...
			{ path: 'src/frontend/src/lib/components/admin/AccountActions.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/AccountInfoCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/AuditTrailCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/CreateRoleDialog.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/CreateUserDialog.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/JobActionsCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/JobExecutionHistory.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/JobInfoCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/JobTable.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/OAuthProviderCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/Pagination.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/RoleCardGrid.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/RoleDeleteSection.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/RoleDetailsCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/RoleManagement.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/RolePermissionEditor.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/RolePermissionsSection.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/UserDetailCards.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/UserManagementCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/UserTable.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/admin/index.ts', templated: false },
			...
			{ path: 'src/frontend/src/lib/components/auth/ForgotPasswordForm.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/auth/LoginForm.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/auth/RegisterForm.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/auth/ResetPasswordForm.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/auth/TurnstileWidget.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/auth/TwoFactorStep.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/auth/index.ts', templated: false },
			...
			{ path: 'src/frontend/src/lib/components/layout/AppSidebar.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/layout/CommandPalette.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/layout/ContentHeader.svelte', templated: false },
			...
			{ path: 'src/frontend/src/lib/components/oauth/ConnectedAccountsCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/oauth/DisconnectDialog.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/oauth/OAuthProviderButton.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/oauth/OAuthProviderButtons.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/oauth/ProviderIcon.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/oauth/index.ts', templated: false },
			{ path: 'src/frontend/src/lib/components/profile/AccountDetails.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/profile/AvatarCropStep.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/profile/AvatarDialog.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/profile/AvatarSelectStep.svelte', templated: false },
			...
			{ path: 'src/frontend/src/lib/components/profile/ProfileHeader.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/profile/index.ts', templated: false },
			{ path: 'src/frontend/src/lib/components/settings/ActivityLog.svelte', templated: false },
			...
			{ path: 'src/frontend/src/lib/components/settings/SetPasswordForm.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/settings/TwoFactorCard.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/settings/TwoFactorDisableDialog.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/settings/TwoFactorRecoveryCodesDialog.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/settings/TwoFactorSetupDialog.svelte', templated: false },
			{ path: 'src/frontend/src/lib/components/settings/index.ts', templated: false },
			...
			{ path: 'src/frontend/src/lib/types/index.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/audit.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/crop.test.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/crop.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/index.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/jobs.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/oauth.test.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/oauth.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/permissions.test.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/permissions.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/platform.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/roles.test.ts', templated: false },
			{ path: 'src/frontend/src/lib/utils/roles.ts', templated: false },
			...
			{ path: 'src/frontend/src/routes/(app)/admin/+layout.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/jobs/+page.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/jobs/+page.svelte', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/jobs/[jobId]/+page.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/jobs/[jobId]/+page.svelte', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/layout.server.test.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/oauth-providers/+page.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/oauth-providers/+page.svelte', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/roles/+page.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/roles/+page.svelte', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/roles/[id]/+page.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/roles/[id]/+page.svelte', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/users/+page.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/users/+page.svelte', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/users/[id]/+page.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(app)/admin/users/[id]/+page.svelte', templated: false },
			...
			{ path: 'src/frontend/src/routes/(app)/settings/+page.svelte', templated: false },
			...
			{ path: 'src/frontend/src/routes/(public)/oauth/callback/+page.server.ts', templated: false },
			{ path: 'src/frontend/src/routes/(public)/oauth/callback/+page.svelte', templated: false },
			{ path: 'src/frontend/src/routes/(public)/oauth/callback/page.server.test.ts', templated: false },
