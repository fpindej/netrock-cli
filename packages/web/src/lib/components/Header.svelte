...
>
	...
	<nav class="hidden items-center gap-1 sm:flex">
		{#each steps as step}
			<a
				href="#{step.id}"
				class="rounded-md px-3 py-1.5 font-mono text-xs transition-colors {activeSection ===
				step.id
	...
	<a
		...
		class="inline-flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs text-text-muted transition-colors hover:text-text-secondary"
	>
